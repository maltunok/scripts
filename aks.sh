...
### Resource groups
export RG_AKS="${PREFIX}-${LOCATION_CODE}-rg"
## export RG_AKS="${PREFIX}-shared-${LOCATION_CODE}"
export NODE_RG_AKS="${PREFIX}-node-${LOCATION_CODE}-tr"
...
### Virtual networks
export PROJ_VNET_NAME="${PREFIX}-${LOCATION_CODE}-vnet"

# export HUB_EXT_VNET_NAME="hub-ext-vnet-${LOCATION_CODE}"
...
export PROJ_VNET_ADDRESS_SPACE_1="10.8.8.0/21"

# 2046 allocated addresses (from 16.0 to 23.255)
export PROJ_VNET_ADDRESS_SPACE_2="10.8.16.0/21"
...
export AKS_SUBNET_IP_PREFIX="10.8.8.0/21"
export SVC_SUBNET_IP_PREFIX="10.8.16.0/24"
...
AKS_CLUSTER_NAME="${PREFIX}-${LOCATION_CODE}-aks"
...
export AKS_SUBNET_ID="/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/${RG_AKS}/providers/Microsoft.Network/virtualNetworks/${PROJ_VNET_NAME}/subnets/${AKS_SUBNET_NAME}"
...
MANAGED_IDENTITY=$(az identity create --name "mngIdentity" --resource-group ${RG_AKS})
